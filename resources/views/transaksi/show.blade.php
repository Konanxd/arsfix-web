<x-app-layout>
    ...
    <div class="p-8">
        ...
        <div class="flex justify-between items-center mt-6 mb-6">
            ...
            @if ($isCompleted)
                <a href="{{ route('transaksi.struk', $transaction->id) }}" target="_blank"
                    class="flex items-center px-5 py-3 border border-blue-600 text-blue-600 rounded-xl hover:bg-blue-50">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="mr-3"
                        viewBox="0 0 20 20">
                        <g fill="currentColor">
                            <rect width="18" height="11" x="2" y="7.5" opacity="0.2" rx="3" />
                            <path
                                d="M5 6.5H4V2.1C4 1.234 4.612.5 5.417.5h9.166C15.388.5 16 1.234 16 2.1v4.4h-1V2.1c0-.35-.209-.6-.417-.6H5.417c-.208 0-.417.25-.417.6z" />
                            <path fill-rule="evenodd"
                                ...
                                clip-rule="evenodd" />
                            <path
                                d="M15 11.969h1v5.25c0 .97-.588 1.812-1.417 1.812H5.417C4.588 19.031 4 18.19 4 17.22v-5.25h1v5.25c0 .479.233.812.417.812h9.166c.184 0 .417-.333.417-.812z" />
                            <path
                                d="M13.5 15.5a.5.5 0 0 1 0 1h-7a.5.5 0 0 1 0-1zm0-2a.5.5 0 0 1 0 1h-7a.5.5 0 0 1 0-1z" />
                        </g>
                    </svg>
            ...
            <div class="flex justify-between mb-6">
                ...
                <div class="text-right">
                    ...
                    <p class="text-base text-gray-800 font-semibold">
                        {{ \Carbon\Carbon::parse($transaction->created_at)->translatedFormat('d F Y') }}</p>
                </div>
            </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex justify-between border-b pb-1">
                            ...
                            <p class="text-gray-800 font-medium">Rp.
                                {{ number_format($repairOrder->estimated_cost, 0, ',', '.') }}</p>
                        </div>
                    </div>
                </div>
