        ...
        <div class="mt-6 space-y-4">
            @forelse ($pesananPerbaikan as $pesanan)
                <div class="bg-white p-4 rounded-lg shadow-md flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <a href="{{ route('pesanan.show', ['id' => $pesanan->id]) }}" class="flex items-center flex-1">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-semibold text-gray-800">{{ $pesanan->customer->name }} | {{ $pesanan->sparePart->name }}</p>
                            <p class="text-sm text-gray-600">{{ $pesanan->customer->phone ?? '-' }} | {{ $pesanan->description }}</p>
                    ...
                    <div class="flex space-x-3 mt-4 lg:mt-0">
                        ...
                        {{-- Tombol "Selesai" dan "Batal" bisa dibuatkan route/aksi khusus jika diperlukan --}}
