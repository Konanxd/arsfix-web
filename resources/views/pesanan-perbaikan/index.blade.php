    ...
    <div class="p-8">
        ...
        <div class="flex justify-between items-center mt-8">
            <form action="{{ route('pesanan.index') }}" method="GET" class="w-full max-w-3xl">
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari data pesanan"
                    ...
                    <a href="{{ route('pesanan.show', $pesanan->id) }}" class="flex items-center flex-1">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">
                                +62 {{ formatPhoneNumber($pesanan->customer->phone_number) ?? '-' }} |
                                {{ $pesanan->customer->handphone }} | {{ $pesanan->description }}
                            </p>
