<x-app-layout>
    <div class="p-4 sm:p-8">
        ...
        <div class="mt-8 bg-white p-8 rounded-lg shadow-md">
            ...
            {{-- ALERT NOTIFICATION --}}
            @if(session('success'))
                <div class="mb-6 p-4 text-green-700 bg-green-100 border border-green-200 rounded-lg flex items-center">
            ...
            <form action="{{ route('suku-cadang.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="space-y-6">
                    <div>
