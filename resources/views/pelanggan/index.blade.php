                ...
                <div
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">+62 {{ formatPhoneNumber($customer->phone_number) ?? '-' }}
                                | {{ $customer->handphone }}</p>
                        </div>
                    </div>
                    <div class="flex space-x-3 self-end lg:self-auto">
                        ...
                        <form id="delete-form-1" action="{{ route('pelanggan.destroy', $customer->id) }}" method="POST"
                            onsubmit="return confirm('Yakin ingin hapus?')">
                            @csrf
                            @method('DELETE')
                            <button type="button" onclick="confirmDelete('delete-form-1')"
