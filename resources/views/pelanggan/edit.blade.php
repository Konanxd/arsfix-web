<x-app-layout>
    <div class="p-8">
        ...
        <div class="flex items-center text-sm font-semibold">
            <a href="{{ route('pelanggan.index') }}" class="text-gray-500 hover:text-gray-700">Data Pelanggan</a>
        ...
        <div class="flex items-center mt-6">
             <a href="{{ route('pelanggan.index') }}" class="flex items-center text-gray-500 hover:text-gray-800">
            ...
            <form action="#" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="nama_pelanggan" class="block mt-1 w-full rounded-xl bg-gray-100 border-transparent focus:ring-2 focus:ring-blue-500" type="text" name="nama_pelanggan" value="Dida Handika" required />
                    ...
                    <div>
                        ...
                        <div class="flex mt-1">
                            ...
                            <input type="text" name="no_telepon" id="no_telepon" value="8459980876"
                    ...
                    <div>
                        ...
                        <x-text-input id="handphone" class="block mt-1 w-full rounded-xl bg-gray-100 border-transparent focus:ring-2 focus:ring-blue-500" type="text" name="handphone" value="Huawei Nova 5T" required />
